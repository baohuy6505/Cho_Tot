<header class="header" id="header">
    <div class="header__left">
        ...
        <span class="header__left-title">Dành cho người bán <i class="fa-solid fa-angle-down"></i>
        ...
        <div class="header__address">
            <i class="fa-solid fa-location-dot"></i><span>Hà nội</span><i class="fa-solid fa-sort-down"></i>
                ...
                <div class="header__form-adress-sub-modal-conscious">
                    ...
                    <div class="header__form-adress-sub-modal-conscious-container-list">
                        <ul class="header__form-adress-sub-modal-conscious-list">
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Tất cả danh mục</span>
            ...
            <div class="header__action-btn-modal">
                <div class="header__action-btn-modal-top">
                    ...
                    <div class="header__action-btn-modal-top-image">
                        <img src="./assets/img/happy_right.webp" alt=""
                    ...
                    <div class="header__action-btn-modal-top-action">
                        ...
                        @else
                             <a href="{{ route('register') }}" class="header__action-btn-modal-top-action-register">
                            Đăng kí
                        </a>
                ...
                <div class="header__action-btn-modal-extensions">
                    <ul class="header__action-btn-modal-extensions-list">
                        <li class="header__action-btn-modal-extensions-item">
                            <a href="" class="header__action-btn-modal-extensions-link">Tin đăng đã lưu</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-extensions-item">
                            <a href="" class="header__action-btn-modal-extensions-link">Tìm kiếm đã lưu</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-extensions-item">
                            <a href="" class="header__action-btn-modal-extensions-link">Lịch sử xem tin</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-extensions-item">
                            <a href="" class="header__action-btn-modal-extensions-link">Đánh giá từ tôi</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                    </ul>
                </div>
                ...
                <div class="header__action-btn-modal-service">
                    <ul class="header__action-btn-modal-service-list">
                        <li class="header__action-btn-modal-service-item">
                            <a href="" class="header__action-btn-modal-service-link">Đồng tốt</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-service-item">
                            <a href="" class="header__action-btn-modal-service-link">Gói PRO</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-service-item">
                            <a href="" class="header__action-btn-modal-service-link">Kênh đối tác</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-service-item">
                            <a href="" class="header__action-btn-modal-service-link">Lịch sử giao dịch</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>

                        <li class="header__action-btn-modal-service-item">
                            <a href="" class="header__action-btn-modal-service-link">Cửa hàng/Chuyên trang</a>

                            <a href="" class="header__action-btn-modal-service-create-now">Tạo ngay</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="header__action-btn-modal-sale">
                    <ul class="header__action-btn-modal-sale-list">
                        <li class="header__action-btn-modal-sale-item">
                            <a href="" class="header__action-btn-modal-sale-link">Chợ Tốt ưu đãi</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-sale-item">
                            <a href="" class="header__action-btn-modal-sale-link">Ưu đãi của tôi</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                    </ul>
                </div>
                ...
                <div class="header__action-btn-modal-other">
                    <ul class="header__action-btn-modal-other-list">
                        <li class="header__action-btn-modal-other-item">
                            <a href="" class="header__action-btn-modal-other-link">Cài đặt tài khoản</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                        <li class="header__action-btn-modal-other-item">
                            <a href="" class="header__action-btn-modal-other-link">Trợ giúp</a>
                            <i class="fa-solid fa-chevron-right"></i>
                        </li>
                    </ul>
                </div>
    ...
    <form action="" class="banner__form">
        ...
        <div class="banner__form-category-modal">
            <ul class="banner__form-category-modal-list">
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category1"><span class="label-text">Tất cả danh mục</span>
                        <input id="category1" type="radio" name="category" />
                        <span class="custom__radaio">
                            <i class="fas fa-check"></i>
                        </span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category2"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category3"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category4"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category5"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category6"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category7"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category8"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category9"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category10"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category11"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category12"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category13"><span class="label-text">Tất cả danh mục</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category14"><span class="label-text">Tất cả danh mục</span>

<header class="header" id="header">
    ...
    <div class="header__left">
            ...
            <div class="header__left-modal-box">
                <ul class="header__left-modal-list">
                    <li data-sub="sub1" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img1.png') }}" alt=""
                    ...
                    <li data-sub="sub2" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img2.png') }}" alt=""
                                class="header__left-modal-link-img" />
                            <span>Xe cộ</span>
                        </a>
                    </li>
                    <li data-sub="sub3" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img3.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub4" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img4.png') }}" alt=""
                                class="header__left-modal-link-img" />
                            <span>Việc làm</span>
                        </a>
                    </li>
                    <li data-sub="sub5" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img5.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub6" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img6.png') }}" alt=""
                                class="header__left-modal-link-img" />
                            <span>Thú cưng</span>
                        </a>
                    </li>
                    <li data-sub="sub7" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img7.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub8" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img8.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub9" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img9.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub10" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img10.png') }}" alt=""
                                class="header__left-modal-link-img" />
                            <span>Mẹ và bé</span>
                        </a>
                    </li>
                    <li data-sub="sub11" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img11.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub12" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img12.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub13" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img13.png') }}" alt=""
                                class="header__left-modal-link-img" />
                    ...
                    <li data-sub="sub14" class="header__left-modal-item">
                        <a href="" class="header__left-modal-link">
                            <img src="{{ asset('images/client/submodalheader/img14.png') }}" alt=""
                                class="header__left-modal-link-img" />
                ...
                <div id="sub2" class="header__left-sub-modal">
                    <ul class="header__left-sub-modal-list">
                        ...
                        <li class="header__left-sub-modal-item">
                            <a href="" class="header__left-sub-modal-link">Xe tải, Xe ben</a>
                        </li>
        ...
        <div class="header__left-title">Dành cho người bán <i class="fa-solid fa-angle-down"></i>
            <div class="header__left-title-modal">
                <ul class="header__left-title-modal-list">
                    <li class="header__left-title-modal-item">
                        <img src="{{ asset('images/client/QuanlyTin/qly-tin.svg') }}" alt=""
                            class="header__left-title-modal-img">
                        <a href="{{ route('client.posts.list') }}" class="header__left-title-modal-link">Quản lí tin</a>
                    </li>
                    <li class="header__left-title-modal-item">
                        <img src="{{ asset('images/client/QuanlyTin/goi-pro.svg') }}" alt=""
                            class="header__left-title-modal-img">
                        <a href="" class="header__left-title-modal-link">Gói Pro</a>
                    </li>
                    <li class="header__left-title-modal-item">
                        <img src="{{ asset('images/client/QuanlyTin/shield-check.svg') }}" alt=""
                            class="header__left-title-modal-img">
                        <a href="" class="header__left-title-modal-link">Dành cho đối tác</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="header__address">
            <i class="fa-solid fa-location-dot"></i><span>Đà Nẵng</span><i class="fa-solid fa-sort-down"></i>
            <!-- Modal Khu vực -->
            <div class="header__form-adress-modal">
                ...
                <div class="header__form-adress-sub-modal-conscious">
                    ...
                    <div class="header__form-adress-sub-modal-conscious-container-list">
                        <ul class="header__form-adress-sub-modal-conscious-list">
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Tp Hồ Chí Minh</span>
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Hà Nội</span>
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Đà Nẵng</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Cần Thơ</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Bình Dương</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">An Giang</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-header-address">Bà Rịa - Vũng Tàu</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                ...
                <div class="header__form-adress-sub-modal-district">
                    ...
                    <div class="header__form-adress-sub-modal-district-container-list">
                        <ul class="header__form-adress-sub-modal-district-list">
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Cẩm Lệ</span>
                                    <input id="category1" type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Hải Châu</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Liên Chiểu</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Ngũ Hành Sơn</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Sơn Trà</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Thanh Khê</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                            ...
                            <li class="header__form-adress-sub-modal-district-item">
                                <label><span class="label-text-header-address">Quận Hòa Vang</span>
                                    <input type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
...
@auth
    <div class="header__action-btn-modal-top-after">
        <div class="header__action-btn-modal-top-after-image">
            {{-- Sử dụng toán tử ?? để code gọn hơn --}}
            <img src="{{ Auth::user()->avatar ?? asset('images/client/profile/default-avatar.jpg') }}" 
                 alt="Avatar" class="header__action-btn-modal-top-after-img" />
        ...
        <div class="header__action-btn-modal-top-after-desc">
            <span class="header__action-btn-modal-top-after-desc-1">Người theo dõi 0</span>
            <span class="header__action-btn-modal-top-after-desc-2">Đang theo dõi 0</span>
        </div>
        ...
        <div class="header__action-btn-top-after">
            <div class="header__action-btn-top-after-list">
                <div class="header__action-btn-top-after-item-1">
                    ...
                    {{-- Dùng thẻ span bao quanh ID để dễ xử lý JS copy sau này --}}
                    <span><span id="user-id">{{ Auth::user()->id }}</span> <i class="fa-solid fa-copy" style="cursor:pointer"></i></span>
                </div>
                <div class="header__action-btn-top-after-item-2">
                    <span>Số dư</span>
                    <span style="color: red; font-weight: bold;">{{ number_format(Auth::user()->balance, 0, ',', '.') }} đ</span>
                </div>
                <a href="{{ route('payment') }}" class="header__action-btn-top-after-item-action">Nạp ngay</a>
            </div>
        </div>
    </div>
@else
    ...
    <div class="header__action-btn-modal-top">
        <div class="header__action-btn-modal-top-content">
            <h4 class="header__action-btn-modal-top-title">Mua thì hời, bán thì lời</h4>
            <p class="header__action-btn-modal-top-desc">Đăng nhập cái đã!</p>
        </div>
        <div class="header__action-btn-modal-top-image">
            <img src="{{ asset('images/client/happy_right.webp') }}" alt="" class="header__action-btn-modal-top-img" />
        </div>
        <div class="header__action-btn-modal-top-action">
            <a href="{{ route('register') }}" class="header__action-btn-modal-top-action-register">Đăng kí</a>
            <a href="{{ route('login') }}" class="header__action-btn-modal-top-action-login">Đăng nhập</a>
        </div>
    </div>
@endauth
                ...
                <div class="header__action-btn-modal-extensions">
                    <ul class="header__action-btn-modal-extensions-list">
                        <li class="header__action-btn-modal-extensions-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/1.svg') }}" alt=""
                                    class="header__action-btn-modal-extensions-item-img">
                        ...
                        <li class="header__action-btn-modal-extensions-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/2.svg') }}" alt=""
                                    class="header__action-btn-modal-extensions-item-img">
                                <a href="" class="header__action-btn-modal-extensions-link">
                                    Tìm kiếm đã lưu
                                </a>
                        ...
                        <li class="header__action-btn-modal-extensions-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/3.svg') }}" alt=""
                                    class="header__action-btn-modal-extensions-item-img">
                                <a href="" class="header__action-btn-modal-extensions-link">
                                    Lịch sử xem tin
                                </a>
                        ...
                        <li class="header__action-btn-modal-extensions-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/4.svg') }}" alt=""
                                    class="header__action-btn-modal-extensions-item-img">
                                <a href="" class="header__action-btn-modal-extensions-link">
                                    Đánh giá từ tôi
                                </a>
                ...
                <div class="header__action-btn-modal-service">
                    <ul class="header__action-btn-modal-service-list">
                        <li class="header__action-btn-modal-service-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/5.svg') }}" alt=""
                                    class="header__action-btn-modal-service-item-img">
                        ...
                        <li class="header__action-btn-modal-service-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/6.svg') }}" alt=""
                                    class="header__action-btn-modal-service-item-img">
                                <a href="" class="header__action-btn-modal-service-link">
                                    Gói PRO
                                </a>
                        ...
                        <li class="header__action-btn-modal-service-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/7.svg') }}" alt=""
                                    class="header__action-btn-modal-service-item-img">
                                <a href="" class="header__action-btn-modal-service-link">
                                    Kênh đối tác
                                </a>
                        ...
                        <li class="header__action-btn-modal-service-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/8.svg') }}" alt=""
                                    class="header__action-btn-modal-service-item-img">
                                <a href="" class="header__action-btn-modal-service-link">
                                    Lịch sử giao dịch
                                </a>
                        ...
                        <li class="header__action-btn-modal-service-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/9.svg') }}" alt=""
                                    class="header__action-btn-modal-service-item-img">
                                <a href="" class="header__action-btn-modal-service-link">
                ...
                <div class="header__action-btn-modal-sale">
                    <ul class="header__action-btn-modal-sale-list">
                        <li class="header__action-btn-modal-sale-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/10.svg') }}" alt=""
                                    class="header__action-btn-modal-sale-item-img">
                        ...
                        <li class="header__action-btn-modal-sale-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/11.svg') }}" alt=""
                                    class="header__action-btn-modal-sale-item-img">
                                <a href="" class="header__action-btn-modal-sale-link">
                                    Ưu đãi của tôi
                                </a>
                ...
                <div class="header__action-btn-modal-other">
                    <ul class="header__action-btn-modal-other-list">
                        <li class="header__action-btn-modal-other-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/12.svg') }}" alt=""
                                    class="header__action-btn-modal-sale-item-img">
                                <a href="" class="header__action-btn-modal-sale-link">
                                    Cài đặt tài khoản
                                </a>
                        ...
                        <li class="header__action-btn-modal-other-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/13.svg') }}" alt=""
                                    class="header__action-btn-modal-sale-item-img">
                                <a href="" class="header__action-btn-modal-sale-link">
                                    Trợ giúp
                                </a>
                        ...
                        <li class="header__action-btn-modal-other-item">
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/14.svg') }}" alt=""
                                    class="header__action-btn-modal-sale-item-img">
                                <a href="" class="header__action-btn-modal-sale-link">
                                    Đóng góp ý kiến
                                </a>
                        ...
                        <form action="{{ route('logout') }}" class="header__action-btn-modal-other-item-action"
                            ...
                            @csrf
                            <div class="wrapper">
                                <img src="{{ asset('images/client/usersIcon/15.svg') }}" alt=""
                                    class="header__action-btn-modal-sale-item-img">
    ...
    <form action="" class="banner__form">
        ...
        <div class="banner__form-category-modal">
            <ul class="banner__form-category-modal-list">
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category1"><span class="label-text">Bất động sản - Mua bán</span>
                        <input id="category1" type="radio" name="category" />
                        <span class="custom__radaio">
                            <i class="fas fa-check"></i>
                        </span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category2"><span class="label-text">Xe cộ</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category3"><span class="label-text">Thời trang, Đồ dùng cá nhân</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category4"><span class="label-text">Giải trí, Thể thao, Sở thích</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category5"><span class="label-text">Đồ điện tử</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category6"><span class="label-text">Dịch vụ, Du lịch</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category7"><span class="label-text">Đồ ăn, Thực phẩm và các loại khác</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category8"><span class="label-text">Đồ dùng văn phòng, công nông nghiệp</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category9"><span class="label-text">Tủ lạnh, máy lạnh, máy giặt</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category10"><span class="label-text">Mẹ và bé</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category11"><span class="label-text">Thú cưng</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category12"><span class="label-text">Việc làm</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category13"><span class="label-text">Đồ gia dụng, nội thất, cây cảnh</span>
                ...
                <li class="banner__form-category-modal-item">
                    <label for="category14"><span class="label-text">Dịch vụ chăm sóc nhà cửa</span>
        ...
        <div class="banner__form-adress">
            ...
            <div class="banner__form-adress-modal">
                ...
                <div class="banner__form-adress-sub-modal-conscious">
                    ...
                    <div class="banner__form-adress-sub-modal-conscious-container-list">
                        <ul class="banner__form-adress-sub-modal-conscious-list">
                            ...
                            <li class="banner__form-adress-sub-modal-conscious-item">
                                <label><span class="label-text-banner-address">Tất cả danh mục</span>
                                    <input id="category1" type="radio" name="category" />
                                    <span class="custom__radaio">
                                        <i class="fas fa-check"></i>
                                    </span>
                ...
                <div class="banner__form-adress-sub-modal-district">
                    ...
                    <div class="banner__form-adress-sub-modal-district-container-list">

...
@php $isLoginStep = isset($showPassword) && $showPassword; @endphp
...
<div class="login-container">
    ...
    <button class="btn-social btn-apple">
        ...
        <form action="{{ $isLoginStep ? route('login') : route('login.check') }}" method="POST">
            ...
            @if($isLoginStep)
                <div class="mb-3">
                    <input type="password" name="password" class="form-control form-control-custom" placeholder="Mật khẩu" required autofocus>
                </div>

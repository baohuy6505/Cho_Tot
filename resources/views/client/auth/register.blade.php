            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-6 small text-muted">
                        <i class="bi bi-check-circle-fill text-secondary me-1"></i> 8-32 ký tự.
                    </div>
                    <div class="col-6 small text-muted">
                        <i class="bi bi-check-circle-fill text-secondary me-1"></i> 1 ký tự HOA.
                    </div>
                    <div class="col-6 small text-muted">
                        <i class="bi bi-check-circle-fill text-secondary me-1"></i> 1 ký tự thường.
                    </div>
                    <div class="col-6 small text-muted">
                        <i class="bi bi-check-circle-fill text-secondary me-1"></i> 1 số.
                    </div>
                </div>
...
<script>
    // Auto-fill password_confirmation to match password

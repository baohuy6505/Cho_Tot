...
<div class="containers">
    <div class="post-ad-page">
        ...
        {{-- Form Section --}}
        <form id="postCreateForm" class="post-form" action="{{ route('client.posts.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control textarea-control" rows="6" 
                          ...
                          placeholder="Nêu rõ tình trạng, phụ kiện, lý do bán, bảo hành...">{{ old('description') }}</textarea>
    ...
    imgInput?.addEventListener('change', (e) => {
        ...
        files.forEach((file, idx) => {
            ...
            reader.onload = (ev) => {
                ...
                item.style.cssText = 'width:90px; height:90px; border-radius:10px; overflow:hidden; border:1px solid #e5e7eb; position:relative; background:#fff;';
                item.innerHTML = `

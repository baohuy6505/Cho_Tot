const dashboardData = {
    chartData: {
        postsByMonth: {
            ...
            data: window.dashboardData.monthlyPosts,
        },
        statusDistribution: {
            labels: ["Hoạt động", "Chờ duyệt", "Bị khóa"],
            data: [
                window.dashboardData.statusDistribution.active,
                window.dashboardData.statusDistribution.pending,
                window.dashboardData.statusDistribution.blocked,
            ],
                ...
                datasets: [
                    {
                        ...
                        backgroundColor:
                            data.chartData.statusDistribution.colors,
                        borderWidth: 2,
                        borderColor: "#fff",
                    },
                ],
